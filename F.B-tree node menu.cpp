...
printf("L?a ch?n:") ;
        ...
        switch (choice) {
        	...
        	case 1: {
				    if (root == NULL || root->n == 0) {
				        ...
				        scanf(" %255[^\n]", filepath);  // Ð?c c? d?ng, bao g?m kho?ng tr?ng
            ...
            case 4: {
                if (root == NULL) {
                    printf("Nh?n 1 ð? t?o B-Tree trý?c khi thêm node!\n");
                    break;
                }
                Student newStudent;
                do {
                ...
                printf("Sinh viên ð? ðý?c thêm vào B-tree.\n");
                break;
            }
             case 5: {
                    ...
                    char mssv[20];
             		...
             		printf("Sinh viên có MSSV %s ð? ðý?c xóa kh?i B-tree.\n", mssv);
             		break;
             		}
             case 6: {
        		...
        		printf("Error: Không th? xác ð?nh thông tin sinh viên.\n");
        		break;
    				}
		...
		case 8: {
			    ...
			    insertBTree(newStudent);
			    printf(" Sinh viên có MSSV %s ð? ðý?c thay th?.\n", mssv);
			    break;
			}
        case 9: {
                if (root == NULL) {
